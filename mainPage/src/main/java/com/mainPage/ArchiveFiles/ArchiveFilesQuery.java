...
public class ArchiveFilesQuery implements Queries {

    private static Logger log = Logger.getLogger(ArchiveFilesQuery.class.getName());
   ...
   //     if (top) query.append(" TOP " + rowIndex + "\n");
    ...
    public String getMainArchiveFilesSearch(Boolean top, int rowIndex, String requestID) {
        ...
        query.append("[tbl_RequestOffering].[ID] AS [ID],\n" +
                ...
                "\t[tbl_RequestOffering].[OfferingGroupID] = '{8DE11B0A-01E4-4842-9F76-EDA6B0395ABD}')) AND\n" +
