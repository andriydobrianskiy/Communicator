...
public class ArchiveFilesRequest {
    ...
    public ArchiveFilesRequest(String index, String skrut, String newDescription, String offeringName, String quantity, String defaultOfferingCode, String newOfferingCode) {
        this.index = index;
        this.skrut = skrut;
