...
public class InTractRequestQuery {

    public String getInTractRequestQuery(boolean top, int rowIndex) {
        ...
        builder.append(" [tbl_OfferingInRequestOffering].[ID] AS [ID],\n" +
                ...
                "WHERE [tbl_OfferingInRequestOffering].[RequestID] = '{5DB34FCE-C73C-4B0A-B7A3-61059FD5519B}' ");
