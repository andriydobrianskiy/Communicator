...
public interface InTractInterface {
    ...
    List<InTract> findInTract(boolean pagination, int rowIndex, String createdByID, String offeringGroupID );
    List<InTract> findInTractAll(boolean pagination, int rowIndex );
}
