...
public class InTractQuery implements Queries {
    private static Logger log = Logger.getLogger(InTractQuery.class.getName());

    private StringBuilder query;

    public String getMainInTract(Boolean top, int rowIndex, String createdByID, String offeringGroupID) {
   ...
   //     if (top) query.append(" TOP " + rowIndex + "\n");
        ...
        query.append("[tbl_RequestOffering].[ID] AS [ID],\n" +
                ...
                "\tISNULL([tbl_RequestOffering].[JointAnnulment], 0) AS [JointAnnulment],\n" +
    ...
    public String getMainInTractSearch(Boolean top, int rowIndex, String createdByID, String offeringGroupID, String requestID) {
