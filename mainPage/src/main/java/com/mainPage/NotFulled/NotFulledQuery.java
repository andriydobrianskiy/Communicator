...
public class NotFulledQuery implements Queries {
    ...
    public String getMainNotFulled(Boolean top, int rowIndex, String createdByID, String offeringGroupID) {
    ...
    /*    query.append(" * from(\n" +
                ...
                "ROW_NUMBER() OVER ( ORDER BY  [tbl_RequestOffering].CreatedOn) AS RowNum,\n" +
                ...
                "\t\n" +
                "\tWHERE \n" +
                " (RequestOffering.RowNum >= 1\n" +
                "    AND RequestOffering.RowNum <= '"+rowIndex+"')");*/
