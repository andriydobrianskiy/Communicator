...
public class InProcessingQuery implements Queries {
   ...
   //     if(top) query.append(" TOP " + rowIndex + "\n");
    ...
    public static String getMainInProcessingSearchSkrut(Boolean top, int rowIndex, String createdByID, String offeringGroupID, String requestID) {
        ...
        query.append( "[tbl_RequestOffering].[ID] AS [ID],\n" +
                ...
                "WHERE(([tbl_RequestOffering].[CreatedByID] = '"+createdByID+"' OR\n" +
                "\t[tbl_RequestOffering].[OfferingGroupID] = '"+offeringGroupID+"' ) AND\n" +
                "\t[tbl_RequestOffering].[StatusID] = '{7CB7F6B9-EB87-48FE-86F6-49ED931A0C0B}' AND [tbl_RequestOffering].[ID] = '"+requestID+"'\n )" +
    ...
    public static String getMainInProcessingAllSearchSkrut(Boolean top, int rowIndex, String requestID) {
        ...
        query.append( "[tbl_RequestOffering].[ID] AS [ID],\n" +
                ...
                "LEFT OUTER JOIN\n" +
                "\t[dbo].[tbl_RequestOfferingState] AS [tbl_RequestOfferingState] ON [tbl_RequestOfferingState].[ID] = [tbl_RequestOffering].[StateID]\n" +
                "WHERE [tbl_RequestOffering].[StatusID] = '{7CB7F6B9-EB87-48FE-86F6-49ED931A0C0B}' AND [tbl_RequestOffering].[ID] = '"+requestID+"'\n" +
                "ORDER BY\n" +
                "\t10 DESC");
    ...
    public long getMainInProcessingCount(Boolean top, String countfilter) {

        query = new StringBuilder();
        long count = 0;
        try {
            query.append("select Count(ID) AS [rowsCount] from tbl_RequestOffering WHERE [StatusID] = '{7CB7F6B9-EB87-48FE-86F6-49ED931A0C0B}' \n");
