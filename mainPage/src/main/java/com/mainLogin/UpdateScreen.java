...
public class UpdateScreen extends StackPane {
     ...
     */
   /* public UpdateScreen() {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/views/UpdateScreen.fxml"));
    ...
    public void initialize() {
        ...
        translate1 = new TranslateTransition(Duration.millis(4000), leftRectangle);
        translate2 = new TranslateTransition(Duration.millis(4000), rightRectangle);
