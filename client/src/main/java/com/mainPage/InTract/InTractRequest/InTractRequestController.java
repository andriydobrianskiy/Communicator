...
public class InTractRequestController extends WorkArea implements Initializable {
    ...
    @FXML
    private FilterableStringTableColumn<InTractRequest, String> colIndex;

    @FXML
    private FilterableStringTableColumn<InTractRequest, String> colSkrut;

    @FXML
    private FilterableStringTableColumn<InTractRequest, String> colNewDescription;

    @FXML
    private FilterableStringTableColumn<InTractRequest, String> colOfferingName;

    @FXML
    private FilterableIntegerTableColumn<InTractRequest, Integer> colQuantity;

    @FXML
    private FilterableStringTableColumn<InTractRequest, String> colDefaultOfferingCode;

    @FXML
    private FilterableStringTableColumn<InTractRequest, String> colNewOfferingCode;
    ...
    private InTract selectedRecord = null;
    ...
    public void loadDataFromDatabase() {
      /*  try {
        ...
        try {
            ...
            data = FXCollections.observableArrayList();
            List<InTractRequest> listItems = derbyInTractRequestDAO.findAll(selectedRecord.getID());
