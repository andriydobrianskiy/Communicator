...
public class ArchiveFilesController extends WorkArea implements MiniFilterFunction, Initializable, DictionaryProperties, ObserverNF {
    ...
    @FXML
    public JFXButton btn_ReturnInProcessing;
    @FXML
    ...
    @FXML
    private FilterableStringTableColumn<ArchiveFiles, String> colNumber;
    @FXML
    private FilterableDateTableColumn<ArchiveFiles, String> colCreatedOn;
    @FXML
    private FilterableStringTableColumn<ArchiveFiles, String> colCreatedBy;
    @FXML
    private FilterableStringTableColumn<ArchiveFiles, String> colAccountCode;
    @FXML
    private FilterableStringTableColumn<ArchiveFiles, String> colAccountName;
    @FXML
    private FilterableDoubleTableColumn<ArchiveFiles, Double> colAccountSaldo;
    @FXML
    private FilterableStringTableColumn<ArchiveFiles, String> colAccountIsSolid;
    @FXML
    private FilterableStringTableColumn<ArchiveFiles, String> colStoreCity;
    @FXML
    private FilterableStringTableColumn<ArchiveFiles, String> colStatus;
    @FXML
    private FilterableStringTableColumn<ArchiveFiles, String> colOfferingGroupName;
    @FXML
    private FilterableStringTableColumn<ArchiveFiles, String> colOriginalGroupName;
    @FXML
    private FilterableStringTableColumn<ArchiveFiles, String> colGroupChangedBy;
    @FXML
    private FilterableStringTableColumn<ArchiveFiles, String> colSpecialMarginTypeName;
    @FXML
    private FilterableStringTableColumn<ArchiveFiles, String> colCashType;
    @FXML
    private FilterableStringTableColumn<ArchiveFiles, String> colPricingDescription;
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        observableList.addAll(btn_ButtonAll.getText(), btn_ButtonPricing.getText(), btn_Button.getText(), btn_ButtonAllPricing.getText(), btn_ReturnInProcessing.getText());
    ...
    public void findByProperty(String value) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                List<ArchiveFiles> listItems = account.findSearchSkrut( Skrut);
    ...
    public BorderPane createPage(int pageIndex) {
        ...
        try {
            ...
            if (queryAll == false) {
                ...
                toIndex = Math.min(fromIndex + itemsPerPage, accountQueries.getMainArchiveFilesCount());

                pageCount = getPageCount((int) accountQueries.getMainArchiveFilesCount(), itemsPerPage);
