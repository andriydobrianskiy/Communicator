...
public final class TrayNotification {
    ...
    @FXML
    private Label lblTitle, lblName, lblMessage, lblClose;
    @FXML
     ...
     */
    public TrayNotification(String title, String name, String body, Image img, Paint rectangleFill) {
        initTrayNotification(title, name, body, NotificationType.CUSTOM);
     ...
     */
    public TrayNotification(String title, String name, String body, NotificationType notificationType ) {
        initTrayNotification(title,name, body, notificationType);
    }
    ...
    private void initTrayNotification(String title, String name, String message, NotificationType type) {
        ...
        try {
            ...
            setTray(title, name, message, type);
    ...
    public void setTray(String title, String name, String message, NotificationType type) {
        setTitle(title);
        setName(name);
        setMessage(message);
    ...
    public void setTray(String title, String name, String message, Image img, AnimationType animType) {
        setTitle(title);
        setName(name);
        setMessage(message);
        setImage(img);
